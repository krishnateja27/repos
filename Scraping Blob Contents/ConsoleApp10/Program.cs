...
{
    public void PrintDirectoryContents(IEnumerable<IListBlobItem> listBlobs, CloudBlobContainer x, int hidelength,String directoryPrefix)
    {
        hidelength = 0;
        foreach (IListBlobItem item in listBlobs)
        {
            ...
            else
            {
                ...
                String directoryName = ((Microsoft.WindowsAzure.Storage.Blob.CloudBlobDirectory)item).Prefix;
                ...
                //directory.Prefix;
                PrintDirectoryContents(directory.ListBlobs(), x, Subdirectorydisplaylength,directoryName);
            }
    ...
    public void PrintBlobContents(IEnumerable<IListBlobItem> listBlobs, CloudBlobContainer x)
    {
        foreach (IListBlobItem item in listBlobs)
        {
            ...
            else
            {
                ...
                PrintDirectoryContents(directory.ListBlobs(), x, displaylength,directoryName);
            }
        }
    }
}
